...
[ExecuteInEditMode]
public class CharacterVisuals : BaseController 
{
	...
	private void Start()
	{
		...
		myRenderer.GetComponent<MeshFilter> ().mesh = sMesh.depthMesh(new Vector2((3)*defaultTexture.width/4,(3-3)*defaultTexture.height/4), new Vector2(defaultTexture.width/4,defaultTexture.height/4));
	}
	...
	public void UpdateImage()
	{
		...
		myRenderer.sharedMaterial.mainTexture=defaultTexture;
		myRenderer.GetComponent<MeshFilter>().mesh=null;
		myRenderer.GetComponent<MeshFilter>().mesh=sMesh.depthMesh(new Vector2((uIndex)*defaultTexture.width/4,(3-yIndex)*defaultTexture.height/4), 
		                                                           new Vector2(defaultTexture.width/4,defaultTexture.height/4));	
	}
